...
from models.DRSformer_arch import Attention as TKSA
from models.modules import TokenShuffleModule, VisualTokenSelection
...
class Block(nn.Module):
    def __init__(
        ...
        self.shift = None
        if ts_layer:
            # self.select = VisualTokenSelection(max_frames=1, embed_dim=dim, topk=29)
            self.shift = TokenShuffleModule()
